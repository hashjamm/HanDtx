...
import org.techtown.handtxver1.databinding.FragmentQType2ContentPage5Binding
 ...
 * Use the [QType2ContentPage5.newInstance] factory method to
 * create an instance of this fragment.
 */
class QType2ContentPage5 : Fragment() {
    // TODO: Rename and change types of parameters

    private lateinit var binding: FragmentQType2ContentPage5Binding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_q_type2_content_page5,
            container,
            false
        )
        return binding.root
    ...
    companion object {
         ...
         * @return A new instance of fragment QType2ContentPage5.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance() =
            QType2ContentPage5().apply {
