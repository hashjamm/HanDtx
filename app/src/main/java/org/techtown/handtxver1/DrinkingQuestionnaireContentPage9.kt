...
import org.techtown.handtxver1.databinding.FragmentDrinkingQuestionnaireContentPage9Binding
 ...
 */
class DrinkingQuestionnaireContentPage9 : Fragment() {
    // TODO: Rename and change types of parameters

    private lateinit var binding: FragmentDrinkingQuestionnaireContentPage9Binding // Data binding 변수 선언
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(
                inflater,
                R.layout.fragment_drinking_questionnaire_content_page9,
                container,
                false
            )
        return binding.root
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() =
            DrinkingQuestionnaireContentPage9().apply {
