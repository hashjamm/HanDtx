...
import org.techtown.handtxver1.databinding.FragmentEmotionDiaryChart3Binding
 ...
 */
class EmotionDiaryChart3 : Fragment(), View.OnClickListener {
    ...
    // binding 변수 생성
    lateinit var binding: FragmentEmotionDiaryChart3Binding
    ...
    override fun onCreateView(
        inflater: LayoutInflater, emotionDiaryChart3: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding =
            DataBindingUtil.inflate(
                inflater,
                R.layout.fragment_emotion_diary_chart3,
                emotionDiaryChart3,
                false
            )
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fun optimizingGraphByScore(score: Int?) {
            ...
            score?.let {
                ...
                if (it in 0..9) {
                    ...
                    binding.howRU.text = objectSet.graphTextArray3[it]
                ...
                binding.howRU.text = "오늘 식욕은 어땠나요?"
        ...
        // 일단 현재 상태에서 그래프 최적화
        viewModel.getEmotionDiaryData(userID!!, viewModel.apiServerDateString.value!!, 3)
...
// textView 의 text 부분을 재정의하는 메서드인 updateTextView 작성
    ...
    private fun setOnClickListener() {
        val chartSequence = binding.emotionDiaryChart3.children
