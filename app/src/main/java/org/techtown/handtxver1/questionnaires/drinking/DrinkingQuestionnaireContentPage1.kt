...
import org.techtown.handtxver1.databinding.FragmentDrinkingQuestionnaireContentPage1Binding
 ...
 */
class DrinkingQuestionnaireContentPage1 : Fragment() {
    // TODO: Rename and change types of parameters

    private lateinit var binding: FragmentDrinkingQuestionnaireContentPage1Binding // Data binding 변수 선언
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(
                inflater,
                R.layout.fragment_drinking_questionnaire_content_page1,
                container,
                false
            )
        return binding.root
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() =
            DrinkingQuestionnaireContentPage1().apply {
