...
import org.techtown.handtxver1.databinding.FragmentQType2ContentPage8Binding
 ...
 * Use the [QType2ContentPage8.newInstance] factory method to
 * create an instance of this fragment.
 */
class QType2ContentPage8 : Fragment() {
    // TODO: Rename and change types of parameters

    private lateinit var binding: FragmentQType2ContentPage8Binding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_q_type2_content_page8,
            container,
            false
        )
        return binding.root
    ...
    companion object {
         ...
         * @return A new instance of fragment QType2ContentPage8.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance() =
            QType2ContentPage8().apply {
