...
import org.techtown.handtxver1.org.techtown.handtxver1.questionnaires.type4.*
...
class QuestionnaireType4 : AppCompatActivity() {
    ...
    private val page1 = QType4ContentPage1()
    private val page2 = QType4ContentPage2()
    private val page3 = QType4ContentPage3()
    private val page4 = QType4ContentPage4()
    private val page5 = QType4ContentPage5()
    private val page6 = QType4ContentPage6()
    private val page7 = QType4ContentPage7()
    private val page8 = QType4ContentPage8()
    private val page9 = QType4ContentPage9()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // ViewModel 에 접근 및 로딩
        val viewModel = ViewModelProvider(this)[ViewModelForQType4::class.java]
    ...
    private var updatePHQ9SurveyInterface: UpdatePHQ9SurveyInterface =
        objectSet.retrofit.create(UpdatePHQ9SurveyInterface::class.java)
    ...
    private fun updateDataIntent(
        ...
        try {
            updatePHQ9SurveyInterface.requestUpdatePHQ9Survey(
                userID,
                date,
                responseSequence[0]!!,
                responseSequence[1]!!,
                ...
                Callback<UpdatePHQ9SurveyOutput> {

                override fun onResponse(
                    call: Call<UpdatePHQ9SurveyOutput>,
                    response: Response<UpdatePHQ9SurveyOutput>
                ) {

                    if (response.isSuccessful) {

                        Toast.makeText(this@QuestionnaireType4, "설문을 완료하였습니다.", Toast.LENGTH_SHORT)
                            .show()
                        ...
                        val errorDialog = android.app.AlertDialog.Builder(this@QuestionnaireType4)
                ...
                override fun onFailure(call: Call<UpdatePHQ9SurveyOutput>, t: Throwable) {
