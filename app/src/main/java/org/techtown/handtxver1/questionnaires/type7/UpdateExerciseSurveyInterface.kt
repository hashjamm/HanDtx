...
interface UpdateExerciseSurveyInterface {

    @FormUrlEncoded
    @POST("hanDtxPrototypeApp/app_update_exercise_survey/")
    fun requestUpdateExerciseSurvey(
        ...
        @Field("result11") result11: Int,
        @Field("result12") result12: Int,
        @Field("exerciseType1") exerciseType1: String?,
        @Field("exerciseType2") exerciseType2: String?,
        @Field("exerciseType3") exerciseType3: String?,
        @Field("inputText") inputText: String?
    ): Call<UpdateExerciseSurveyOutput>
