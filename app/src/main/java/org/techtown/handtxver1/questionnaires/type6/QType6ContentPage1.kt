...
import org.techtown.handtxver1.databinding.FragmentQType6ContentPage1Binding
 ...
 */
class QType6ContentPage1 : Fragment() {
    // TODO: Rename and change types of parameters

    private lateinit var binding: FragmentQType6ContentPage1Binding
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(
                inflater,
                R.layout.fragment_q_type6_content_page1,
                container,
                false
            )
        return binding.root
    ...
    private fun onRadioButtonClicked(view: View) {
        ...
        if (view is RadioButton) {
            ...
            if (checked && responseValue != null) {
                viewModel.updateResponse(1, responseValue)
            }
        }
