...
import org.techtown.handtxver1.databinding.FragmentQType7ContentPage11Binding
 ...
 */
class QType7ContentPage11 : Fragment() {
    // TODO: Rename and change types of parameters

    private lateinit var binding: FragmentQType7ContentPage11Binding
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(
                inflater,
                R.layout.fragment_q_type7_content_page11,
                container,
                false
            )
    ...
    private fun onRadioButtonClicked(view: View) {
        ...
        if (view is RadioButton) {
            ...
            if (checked && responseValue != null) {
                viewModel.updateResponse(11, responseValue)
            }
