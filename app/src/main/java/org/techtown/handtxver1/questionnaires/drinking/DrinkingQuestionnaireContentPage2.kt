 ...
 */
class DrinkingQuestionnaireContentPage2 : Fragment() {
    // TODO: Rename and change types of parameters

    private lateinit var binding: FragmentDrinkingQuestionnaireContentPage2Binding // Data binding 변수 선언
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(
                inflater,
                R.layout.fragment_drinking_questionnaire_content_page2,
                container,
                false
            )
        return binding.root
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() =
            DrinkingQuestionnaireContentPage2().apply {
