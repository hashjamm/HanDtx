...
class QuestionnaireType8 : AppCompatActivity() {
    ...
    private val page3 = QType8ContentPage3()
    private val page4 = QType8ContentPage4()
    private val page5 = QType8ContentPage5()
    private val page6 = QType8ContentPage6()
    private val page7 = QType8ContentPage7()
    private val page8 = QType8ContentPage8()
    private val page9 = QType8ContentPage9()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toNextPage.setOnClickListener {
            ...
            if (currentPageNumber == 1 && viewModel.responseSequence[currentPageIndex] == 0) {

                changeQuestionnaire(DrinkingQuestionnaire())
        ...
        toPreviousPage.setOnClickListener {
            ...
            if (currentPageNumber in 2 until pageSequence.size + 1) {
                ...
                supportFragmentManager.beginTransaction()
                    .replace(frameLayoutID, previousPage)
                    .commitNow()
        ...
        updateSmokingDrinkingSurveyInterface.requestUpdateSmokingDrinkingSurvey(
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    Toast.makeText(this@QuestionnaireType8, "설문을 완료하였습니다.", Toast.LENGTH_SHORT)
                        .show()
                    ...
                    val errorDialog = android.app.AlertDialog.Builder(this@QuestionnaireType8)
