...
import org.techtown.handtxver1.org.techtown.handtxver1.questionnaires.type3.*
...
class QuestionnaireType3 : AppCompatActivity() {
    ...
    private var updateWellBeingScaleSurveyInterface: UpdateWellBeingScaleSurveyInterface =
    ...
    private fun updateDataIntent(
        ...
        try {
            updateWellBeingScaleSurveyInterface.requestUpdateWellBeingScaleSurvey(
                userID,
                date,
                responseSequence[0]!!,
                responseSequence[1]!!,
                ...
                Callback<UpdateWellBeingScaleSurveyOutput> {

                override fun onResponse(
                    call: Call<UpdateWellBeingScaleSurveyOutput>,
                    response: Response<UpdateWellBeingScaleSurveyOutput>
                ) {

                    if (response.isSuccessful) {

                        Toast.makeText(this@QuestionnaireType3, "설문을 완료하였습니다.", Toast.LENGTH_SHORT)
                            .show()
                        ...
                        val errorDialog = android.app.AlertDialog.Builder(this@QuestionnaireType3)
                ...
                override fun onFailure(call: Call<UpdateWellBeingScaleSurveyOutput>, t: Throwable) {
