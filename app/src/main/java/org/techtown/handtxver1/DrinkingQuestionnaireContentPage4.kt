...
import org.techtown.handtxver1.databinding.FragmentDrinkingQuestionnaireContentPage4Binding
 ...
 */
class DrinkingQuestionnaireContentPage4 : Fragment() {
    // TODO: Rename and change types of parameters

    private lateinit var binding: FragmentDrinkingQuestionnaireContentPage4Binding // Data binding 변수 선언
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(
                inflater,
                R.layout.fragment_drinking_questionnaire_content_page4,
                container,
                false
            )
        return binding.root
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() =
            DrinkingQuestionnaireContentPage4().apply {
