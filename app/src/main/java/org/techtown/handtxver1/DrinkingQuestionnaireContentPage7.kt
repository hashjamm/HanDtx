...
import org.techtown.handtxver1.databinding.FragmentDrinkingQuestionnaireContentPage7Binding
 ...
 */
class DrinkingQuestionnaireContentPage7 : Fragment() {
    // TODO: Rename and change types of parameters

    private lateinit var binding: FragmentDrinkingQuestionnaireContentPage7Binding // Data binding 변수 선언
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(
                inflater,
                R.layout.fragment_drinking_questionnaire_content_page7,
                container,
                false
            )
        return binding.root
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() =
            DrinkingQuestionnaireContentPage7().apply {
